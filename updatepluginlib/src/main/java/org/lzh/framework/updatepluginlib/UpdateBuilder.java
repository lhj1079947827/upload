...
public class UpdateBuilder {
    ...
    /**
     * 注意当改参数为false时候方法  setUpdateParser中response为空,但是返回的Update用户自己定义下载地址版本号名字等。
     * 当netWork=false时 url将不起作用
     * 默认为true
     * @param netWork true用于是否执行网络请求获取app下载信息
     * @return
     */
    public UpdateBuilder setNetWork(Boolean netWork){
        if (this.entity==null){
